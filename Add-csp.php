         ...
         <form action="submit.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="tab-content" id="myTabContent">
               <div
                  ...
                  <div class="row">
                     ...
                     <div class="my-2 col-md-4">
                        ...
                        WhatsApp No <span class="req"> * </span>
                        </label>
                     ...
                     <div class="my-2 col-md-4">
                        ...
                        Family Mobile No <span class="req"> * </span>
                        </label>
                        <div class="input-group">
                           <span class="input-group-text">+91</span>
                           <input
               ...
               <div
                  ...
                  <div class="row">
                     <div class="my-2 col-md-4">
                        <label for="aadharMobile" class="form-label">
                        Aadhar link Mobile No <span class="req"> * </span>
                        </label>
                        <div class="input-group">
                           <span class="input-group-text">+91</span>
                           <input
               ...
               <div
                  ...
                  <div class="row">
                     ...
                     <div class="my-2 col-md-4">
                        <label for="referNo" class="form-label">
                        Reference Mobile No <span class="req"> * </span>
                        </label>
                        <div class="input-group">
                           <span class="input-group-text">+91</span>
                           <input
